...
import mas.com.filmLib.databinding.SearchDialogFragmentBinding
import mas.com.filmLib.utils.getEmptyString
...
class SearchDialogFragment : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        vb = SearchDialogFragmentBinding.inflate(layoutInflater)
        return vb?.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        vb?.let {
            ...
            clearTextImageView = it.clearTextImageview
            searchButton = it.searchButtonTextview
        }
